...
if __name__ == '__main__':
    ...
    if(args.natributos==1): #3.1
        ...
        theta_0, theta_1, cost_graph, theta_0_progress, theta_1_progress = gradient_descent( new_data, starting_theta_0=100, starting_theta_n=[0.0], learning_rate=0.001, num_iterations=args.iterations)  
